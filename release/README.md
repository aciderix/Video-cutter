...
> ⚠️ Built from `claude/loving-ptolemy-x0AY6` at v0.3.0 (preview cuts +
...
│       └── quietcut-0.3.0_amd64.deb      3.3 MB Debian/Ubuntu package
└── mobile/
    └── android/
        └── quietcut-0.3.0-debug.apk      3.9 MB Capacitor debug APK (unsigned)
```
