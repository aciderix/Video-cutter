...
> ⚠️ Built from `claude/loving-ptolemy-x0AY6` at v0.2.0 (post-audit fixes).
...
│       └── quietcut-0.2.0_amd64.deb      3.2 MB Debian/Ubuntu package
└── mobile/
    └── android/
        └── quietcut-0.2.0-debug.apk      3.8 MB Capacitor debug APK (unsigned)
```
